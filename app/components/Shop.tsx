...
const products: Product[] = [
  {
    ...
    button: "Preorder",
    tag: "Coming Soon",
    printfulVariantId: 1001, // replace with real Printful variant ID
    price: 14900,
  },
  {
    ...
    button: "Preorder",
    tag: "Limited Release",
    printfulVariantId: 1002, // replace with real Printful variant ID
    price: 39900,
  },
  {
...
// Shipping address collected at checkout — hardcoded placeholder;
// in production replace with a form or Stripe's built-in address collection.
          ...
          {products.map((item) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <button
                  onClick={() => !item.soldOut && addToCart(item)}
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-[#ff4d4d]/30 bg-black/90 backdrop-blur-md">
          <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-4 md:px-10">
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={() => setCart([])}
                className="font-mono text-xs uppercase tracking-[0.2em] text-white/30 hover:text-white/60 transition"
              >
                Clear
              </button>
              ...
              <button
                ...
                disabled={loading}
                className="relative overflow-hidden border border-[#ff4d4d]/50 bg-[#ff2b2b]/15 px-6 py-3 font-mono text-xs uppercase tracking-[0.3em] text-[#ffb3b3] transition duration-300 hover:bg-[#ff2b2b]/25 hover:shadow-[0_0_30px_rgba(255,0,0,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
              >
